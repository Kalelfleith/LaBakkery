...
public class ProdutoRest extends UtilRest{
	...
	public Response buscar() {
		...
		try {
			...
			listaProdutos = jdbcProduto.buscar();
	...
	//Método Utilizado para capturar no Banco a Quantidade e Valor do Estoque
		@GET
		@Path("/buscarProdutoEstoque")
		@Consumes("application/*")
		@Produces(MediaType.APPLICATION_JSON)
		public Response buscarProdutoEstoque(@QueryParam("id") int id) {
			...
			try {
				...
				produto = jdbcProduto.buscarProdutoEstoque(id);
